...
public class FloorAdapter extends RecyclerView.Adapter<FloorAdapter.ViewHolder> {
    ...
    void setFloors(List<Floor> floors) {
        this.floors = floors;
        notifyItemRangeChanged(0, getItemCount()); //notify adapter about changes
    }

    @NonNull
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //create view by inflating the xml file
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        //update contents of view to reflect floor at given position
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Floor floor) {
            ...
            //set floor name and background resource
